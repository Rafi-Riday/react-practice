const strAndNumArray: (string | number)[] = ['cse', 'eee'];
/**
...
let strOrNumArray: string[] | number[] | boolean[] = ['ec', 'me'];
strOrNumArray = [69, 96];
 ...
 */
const newTuple: [string, boolean, number, boolean, string] = ['str', false, 69, true, 'str'];
